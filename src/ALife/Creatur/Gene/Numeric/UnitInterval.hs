...
import           ALife.Creatur.Gene.Numeric.Util
    (adjustNum, inRange, scaleToWord8)
...
-- | Difference between integers, expressed as a number
...
-- | @'adjustIntegral' target r n@ adjusts @n@ to make it
--   similar to @target@.
--   The amount of adjustment is controlled by @r@, where 0 <= @r@ <= 1.
--   If @r@=0, the result will be identical to @n@.
